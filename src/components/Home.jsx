...
const Home = () => {
  return (
    <div className="flex mt-32 large:mt-0">
      <div className=" mr-36 mt-16 large:mr-16 ">
      ...
      <div className="flex large:flex-col large:pl-16 large:pr-16">
        <div className="basis-3/6 large:order-2 large:w-8/12">
          <h1 className="text-big-font large:mt-2">
            {" "}
            Jitto Joyes
            <svg
              width={36}
