...
const Navbar = () => {
  ...
  return (
    <div
      className="flex fixed z-10 top-0  h-24 py-8 px-0   justify-between container bg-body-color large:top-auto large:bottom-0
    ...
    >
      ...
      >
        <li className=" cursor-pointer  text-title-color hover:text-title-color-dark">
          ...
          <span onClick={() => scrollTo(0, 0)} className="inline-block">
            Home
          </span>
        </li>
        <li className=" cursor-pointer text-title-color hover:text-title-color-dark">
          ...
          <a
            className="inline-block text-title-color hover:text-title-color-dark"
            href="#about"
          >
            About
          </a>
